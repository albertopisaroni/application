...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Newo - Il fisco, ma intelligente'),
    'docs_name' => env('DOCS_NAME', 'Documentazione Newo'),
    ...
    */
    ...
    'url' => env('WEBSITE_URL', 'https://newo.io'),
    'app_url' => env('APP_URL', 'https://app.newo.io'),
