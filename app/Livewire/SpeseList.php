...
class SpeseList extends Component
{
    use WithPagination;
    ...
    {
        try {
            $invoice = InvoicePassive::findOrFail($invoiceId);
    ...
    public function mount()
    {
        ...
        $this->years = InvoicePassive::selectRaw('YEAR(fiscal_year) as year')
    ...
    public function render()
    {
        ...
        $query = InvoicePassive::with(['supplier', 'payments'])
        ...
        return view('livewire.spese-list', [
            'expenses' => $expenses,
