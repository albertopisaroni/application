<div class="px-2">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-normal">Note di credito</h1>
        ...
        <livewire:fiscoapi-session-button />
            ...
            <a href="{{ route('note-di-credito.nuova') }}" wire:navigate class="items-center gap-x-2 flex bg-black text-white px-4 py-2 text-sm rounded-[4px] transition">
                <svg width="11" height="17" viewBox="0 0 11 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_569_5702)">
                    <path d="M6.50062 0.5C6.67973 0.586454 6.79013 0.711577 6.75418 0.923154L6.02499 6.493H10.5442C10.675 6.493 10.8805 6.84542 10.7466 6.97557L5.44883 16.3243C5.18286 16.694 4.733 16.4283 4. 16.014L5.39092 10.5092H0.93466C0.832853 10.5092 0.620968 10.214 0.704004 10.0926L6.06285 0.772881C6.13188 0.649959 6.21269 0.560675 6.34218 0.5H6.50062Z" fill="white"/>
                    </g>
                    <defs>
    ...
    <div class="relative flex mb-6 bg-[#f5f5f5] rounded-[4px] items-center pl-4 pr-2">
        ...
        <input id="searchInput" wire:model.debounce.live.500ms="search" type="text" placeholder="Cerca per nome cliente o numero nota di credito" class="bg-[#f5f5f5] rounded-[4px] border-0 ring-0 focus:ring-0 pr-4 py-2 w-full text-sm">
    ...
    <div class="mb-3 text-sm text-gray-600 flex items-center gap-x-8">
        ...
        <div class="bg-[#dcf3fd] text-[#616161] rounded-[6.75px] px-4 py-2 text-sm flex gap-x-1 items-center">
            ...
            Ci sono <strong>{{ $unpaidCount }} note di credito</strong> da incassare per un totale di <strong>€ {{ number_format($unpaidTotal, 2, ',', '.') }}</strong>
        </div>
    </div>
